...
function initAddClass() {
  $(".btn-search, .close-btn").click(function () {
    $("body").toggleClass("search-active");
  });
  $(".nav-opener").click(function () {
    $(".nav-holder").toggleClass("nav-active");
  });
  $(".cart-box").click(function () {
    $(".icon-list").toggleClass("cart-active");
  });
}
...
function initIsoTop() {
  // Isotope init
  var isotopeHolder = $("#masonry-container"),
    win = $(window);
  ...
  if (element) {
    $.ajax({
      ...
      success: function (data) {
        ...
        $(".changer-opener").click(function (event) {
